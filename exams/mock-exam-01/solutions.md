...
2. What constraint matters most?
        ↓
3. What is the strongest keyword or clue?
        ↓
4. Which AWS capability directly solves it?
        ↓
5. Which service provides that capability?
        ↓
6. Why do the alternatives fail?
        ↓
7. What pattern can be reused in another question?
```

# High-Signal Rules

```text
Authorization ≠ Network Connectivity

Availability ≠ Read Scaling

Replication ≠ Point-in-Time Recovery

Read-Only Access ≠ WORM / Immutability

Encryption ≠ Deletion Protection

Data Movement ≠ Ongoing File Access
...
Reserved = Predictable Long-Term Usage

On-Demand = Flexible / Intermittent Usage
...
> **Do not start with: "Which AWS service do I know?"**
>
> **Start with the requirement. Then choose the AWS service whose native capability solves that requirement most directly, without unnecessary architecture or operational overhead.**
